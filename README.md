...
A simple and modern Todo app built with **Next.js 14**, **TypeScript**, and **JSON Server** as a mock backend.  
...
This home page renders a list of all the todos in the backend. You have the possibility to add a new todo by clicking the "Add todo" button in the top of the list. By doing that, you open a Dialog component which you can complete the Title and the Conclusion date of the Todo. After that you can click the "Save" button and see the new todo appears in the list.
You can also mark a todo as "Done" by clicking in the checkbox in the todo row.

### Route "/[id]"

This page renders the page of a specific todo. In this page you can edit the todos title and conclusion date by clicking in the pencil icon and confirming the edition by clicking in the "check" icon that appears in the place of the pencil icon.
...
- it has an onSubmit function to handle the form submition. This is your custom function, the logic YOU want to pass when submitting the form. you have to pass it as a parameter of the handleSubmit function getted from the useForm hook. this "handleSubmit" function should be called when the form is submitted.
...
- You can see the p tag that renders the Todo conclusion date if the editMode is false and a React Datepicker if the the editMode state is true.
...
- You can also find the Pencil Icon. If you click it, you make the editMode true and it is possible to edit the title and the conclusion date. After changing these fields, you can click in the "check" Icon that was rendered in the place of the pencil to confirm the changes.
